$(document).ready(function (){
		 ...
		 // document.cookie = "IdPosta=15";
		  document.cookie = "Lenta=0";
		  document.cookie = "IdAvtora=1";
		  var lenta = get_cookie("Lenta");
		  //var lenta2 = get_cookie("IdAvtora");
		  //alert(lenta2);
		  PageMethods.Zapros_Page(lenta, CallServerResult);

	     }

	     //получить значение для ленки из кукиз
    ...
    var LinkButtonAvtor = document.createElement('LinkButton');  
        LinkButtonAvtor.innerHTML =  user.avtorname[schet];
    ...
    botPanelbutton.style.width = documentWidth-25+" px";
	   ...
	   // lenta = sum(lenta,go);
	  //  alert(lenta);
	   //записываем в куки новое значение для ленты
